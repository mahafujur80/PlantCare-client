...
export default function PlantCardSkeleton() {
  return (
    <div className="flex flex-col h-[420px] w-full rounded-2xl bg-white border border-slate-100 dark:bg-slate-800 dark:border-slate-700 overflow-hidden animate-pulse">
      {/* Image Skeleton */}
